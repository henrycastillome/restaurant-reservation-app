...
describe("fetchAPI", () => {
  it("it return the availabel time for a given date,", () => {
    const inputDate = new Date("04-03-2023");

    const result = fetchAPI(inputDate);

    expect(Array.isArray(result)).toBe(true); //testing that the array is not empty
